...
<?php
    ...
    print '<label for="firstname"> Your First Name:</label>';
    print $_SESSION['fName'] . "<br>";
    print '<label for="lastname">Your Last Name:</label>';
    print $_SESSION['lName'] . "<br>";
   print  '<label for="UserName">Your User Name:</label>';
   print $_SESSION['UserName'] . "<br>";
	print  '<label for="GWID">Your GWU ID:</label>';
	   print $_SESSION['GWUID'] . "<br>";
